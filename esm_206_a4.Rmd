...
med_mpa_2012 <- median(mpa_2012$size_mm, na.rm = TRUE)
med_mpa_2018 <- median(mpa_2018$size_mm, na.rm = TRUE)
med_nonmpa_2012 <- median(nonmpa_2012$size_mm, na.rm = TRUE)
med_nonmpa_2018 <- median(nonmpa_2018$size_mm, na.rm = TRUE)
