...
The California Spiny Lobster, *Panulirus interruptus*, is a Decapod crustacean that has a habitat that spans from the Monterey Bay, California to Baja California, Mexico (Sea Grant California XXXX). The California Spiny Lobster is one of the largest spiny lobsters in the world with males being able to grow up to three feet long and weigh up to 26 pounds. Fishing of California Lobster is regulated by the California Department of Fish and Wildlife and have an open season from October through March (Sea Grant California and California Department of Fish and Wildlife XXXX). The California Spiny Lobster currently has a stable population and is caught by  commercial fisheries, hoop-net based recreational fishers, and dive-based recreational fishers (Sea Grant California XXXX).

Data on California Spiny Lobsters has been collected off of the coast of Santa Barbara by the Santa Barbara Coastal Term Ecological Research (SBC LTER), an interdisciplinary program based at the University of California, Santa Barbara Marine Science Institute.
![](spiny_guy.png)
