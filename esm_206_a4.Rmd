...
The California Spiny Lobster, *Panulirus interruptus*, is a decapod crustacean that has a habitat that spans from the Monterey Bay, California to Baja California, Mexico (Sea Grant California XXXX). The California Spiny Lobster is one of the largest spiny lobsters in the world with males capable of growing up to three feet long and weighing up to 26 pounds. Fishing of California Spiny Lobster is regulated by the California Department of Fish and Wildlife and has an open season from October through March (Sea Grant California and California Department of Fish and Wildlife XXXX).
...
**Figure 1: Spiny Lobster.** Picture of a California Spiny Lobster *(Credit: [Alamy] (https://www.alamy.com/stock-photo/california-spiny-lobster.html))*
...
**Figure 2. Study Sites.** The five California Spiny Lobster study sites where data is collected by SBC LTER.  *(Credit: [EDI Data Portal](https://portal.edirepository.org/nis/mapbrowse?scope=knb-lter-sbc&identifier=77&revision=newest))*
...
ggplot(lobster_ysite, aes(x = year, y = total_count, fill = site),
  ...
  labs(title = "Annual Lobster Abundance by Site, 2012 - 2018",
       ...
       fill = "Site")
```
***Figure 3: Annual Lobster Abundance.*** 
*Lobster counts at the five study sites between the years of 2012 - 2018 as measured by SBC LTER.*
...
ggplot(data = lobster_size) +
  ...
  labs(title = "Lobster Size Distributions across 5 Sites",
       ...
       y = "Total Lobster Observations")
```
***Figure 4: Lobster Size for 2012 & 2018***
*Lobster size distribution of observations across the five SBC LTER study sites for the years 2012 and 2018.*
